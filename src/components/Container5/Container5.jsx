      ...
      <div className="image-container" id="container-5">
        <figure className="figure">
          <a className="anchor" href="https://cadtabs.com/product-category/cadd-course/">
            <img className="figure-img" src="images/image-container-2/pexels-grovebrands-15764116.jpg" alt="CADD Course" title="CADD Course" />
        ...
        <figure className="figure">
          <a className="anchor" href="https://cadtabs.com/product-category/quantity-surverying/">
            <img className="figure-img" src="images/image-container-2/pexels-fauxels-3183153.jpg" alt="Quantity Surveying" title="Quantity Surveying" />
        ...
        <figure className="figure">
          <a className="anchor" href="https://cadtabs.com/product-category/interior-design/">
            <img className="figure-img" src="images/image-container-2/home-decoration-property-living-room-room-apartment-945407-pxhere.com.jpg" alt="Interior Design" title="Interior Design" />
        ...
        <figure className="figure">
          <a className="anchor" href="https://cadtabs.com/product-category/import-export/">
            <img className="figure-img" src="images/image-container-2/sea-4106040_1280.jpg" alt="Import Export" title="Import Export" />
